...
describe('move', () => {
  ...
  it('throws an error if the folder has two files with the same name.', () => {
    const list = [
      {
        id: '1',
        name: 'Folder 1',
      ...
      },
      {
        id: '6',
        name: 'Folder 2',
        files: [{ id: '7', name: 'File 3' }],
      },
    ];

    expect(() => move(list, '4', '6')).toThrow(
      'You cannot move two files with the same name into the same folder.',
    );
  });
});
